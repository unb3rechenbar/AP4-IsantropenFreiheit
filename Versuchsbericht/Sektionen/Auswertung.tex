...
\begin{document}
    ...
    \subsection*{Analysis of first measure}
        ...
        \subsubsection*{73 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 73 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 73 Grad.tex}

        \subsubsection*{68 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 68 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 68 Grad.tex}

        \subsubsection*{63 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 63 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 63 Grad.tex}
        
        \subsubsection*{58 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 58 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 58 Grad.tex}
        
        \subsubsection*{53 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 53 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 53 Grad.tex}
        
        \subsubsection*{38 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 38 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 38 Grad.tex}
        
        \subsubsection*{31 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 31 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 31 Grad.tex}

        \subsubsection*{15 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 15 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 15 Grad.tex}

        \subsubsection*{10 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 10 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 10 Grad.tex}

        \subsubsection*{4 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 4 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 4 Grad.tex}
        
        \subsubsection*{0 degrees}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Graphen/Temperaturmessung 0 Grad.tex}
            \input{Sektionen/AuswertungsergebnisseFreiheit/Tabellen/Temperaturmessung 0 Grad.tex}
